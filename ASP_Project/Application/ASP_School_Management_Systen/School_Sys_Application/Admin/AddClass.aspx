<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="AddClass.aspx.cs" Inherits="School_Sys_Application.Admin.AddClass" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-lg-5">
                <div class="col-md-6">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="class name is required" ControlToValidate="txtClass"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-lg-5">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-6">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" DataKeyNames="classId" AutoGenerateColumns="False"
