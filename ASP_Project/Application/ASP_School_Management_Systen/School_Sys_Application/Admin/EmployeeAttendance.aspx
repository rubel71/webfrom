<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="EmployeeAttendance.aspx.cs" Inherits="School_Sys_Application.Admin.EmployeeAttendance" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-lg-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAttendance" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558C9" Text="Mark Attendance" OnClick="btnAttendance_Click" />
                </div>
            </div>
        </div>
    </div>
